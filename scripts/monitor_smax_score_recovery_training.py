#!/usr/bin/env python3
"""Show progress of every score-recovery training run in a launcher root."""
...
try:
    from scripts.run_smax_score_recovery_training import Run
except ModuleNotFoundError:  # Direct execution from scripts/.
    from run_smax_score_recovery_training import Run
